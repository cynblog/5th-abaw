...
if __name__ == '__main__':
    root_video_path = '/data0/zza/cvpr23_competition/cvpr23_competition_data/videos'
    dataset_path = '/data0/zza/cvpr23_competition/cvpr23_competition_data'

    for chal in [ 'AU',]: 
        with open('{}/testset/{}_test_set_release.txt'.format(dataset_path, 'Action_Unit_Detection_Challenge'), 'r') as fd:
