...
if __name__ == '__main__':
    ...
    parser.add_argument('--root_dir', type=str, default='/data0/zza/cvpr23_competition/cvpr23_competition_data', help='Root data folder')
    parser.add_argument('--out_dir', type=str, default='/data0/zza/cvpr23_competition/cvpr23_competition_data', help='Out data folder')
    args = parser.parse_args()

    root_dir = pathlib.Path(args.root_dir)
    cropped_aligned = root_dir / 'cropped_aligned'
    # print(cropped_aligned)
    annotations = root_dir / '5th_ABAW_Annotations'
